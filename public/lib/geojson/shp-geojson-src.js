/**
 * shp与geojson互转工具类
 * 编译日期：2025-08-27 10:55
 * 版权所有：Copyright by 木遥
 */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
  typeof define === 'function' && define.amd ? define(['exports'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.shpUtil = {}));
  ...
  */
  ...
  function createDecoder(encoding, second) {
    ...
    try {
      ...
      var match = regex$1.exec(encoding);
      if (match && !second) {
  ...
  const parseZip = async function (buffer, whiteList, encoding, crs) {
    let key;
  ...
  const checkSuffix = (base, suffix) => {
    const url = new URL$1(base, globalThis?.document?.location);
  ...
  const getShapefile = async function (base, whiteList, encoding, crs) {
  ...
  exports.getShapefile = getShapefile;
  exports.parseDbf = _parseDbf;
  exports.parseShp = _parseShp;
