...
function addDemoGraphic1(graphicLayer) {
  ...
  // position支持多种类型：http://mars3d.cn/api/LngLatPoint.html#.parse
  const graphic = new mars3d.graphic.BillboardEntity({
    // position: new mars3d.LngLatPoint(117.273005, 31.85256, 16), // 支持多种类型坐标格式
    // position: Cesium.Cartesian3.fromDegrees(117.273005, 31.85256, 16),
    position: [117.273005, 31.85256, 16],
    style: {
...
function addDemoGraphic2(graphicLayer) {
  ...
  // positions数组内单个坐标同样支持多种类型：http://mars3d.cn/api/LngLatPoint.html#.parse
