...
function creatreDmzList() {
  const arr = [
    { name: "站点1", radius: 1500000, point: [113.061876, 41.660806, 100] },
    { name: "站点2", radius: 1800000, point: [77.247321, 39.398659, 100] },
    { name: "站点3", radius: 1200000, point: [111.362546, 21.795319, 100] }
  ]
