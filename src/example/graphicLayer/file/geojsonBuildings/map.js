...
function fontSize(res) {
  var font_size = window.getComputedStyle(document.documentElement).fontSize.replace("px", "") * 1
  return res * font_size
}

function initEcharts(dom) {
  // 饼形图
  var myChart = echarts.init(dom.value.ring)
  var option = {
  ...
  // 柱状图
  var myChart2 = echarts.init(dom.value.bar, "dark")
  var option2 = {
    backgroundColor: "transparent",
  ...
  // 折线图
  const myChart3 = echarts.init(dom.value.line, "dark")
  var option3 = {
    backgroundColor: "transparent",
