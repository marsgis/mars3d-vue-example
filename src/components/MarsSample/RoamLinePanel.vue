...
onMounted(() => {
  ...
  mapWork.roamLine.on("change", () => {
    ...
    formState.td_wd = mapWork.roamLineData.td_wd
    formState.td_gd = mapWork.roamLineData.td_gd
    formState.td_dmhb = mapWork.roamLineData.td_dmhb
    formState.td_ldgd = mapWork.roamLineData.td_ldgd
    formState.percent = mapWork.roamLineData.percent
  })
})
</script>
