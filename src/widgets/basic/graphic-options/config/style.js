  ...
  hollowCylinder: {
    ...
    style: [
...

      {
        ...
        defval: "Color",
        data: [
          { label: "纯色", value: "Color", defval: { color: "#00ff00" } },
          { label: "随机色", value: "RandomColor" }
          // { label: "波纹扩散", value: "CircleWave" },
          // { label: "条纹扩散", value: "CylinderWave" }
        ],
  ...
  polygon: {
    ...
    style: [
      ...
      },
      {
        ...
        defval: 1.0,
        show({ style, allStyle }) {
          return allStyle?.outline && !allStyle?.diffHeight && typeof style?.outlineStyle?.width !== "number"
        }
      },
      {
        name: "outlineColor",
        ...
        defval: "#ffffff",
        show({ style, allStyle }) {
          return allStyle?.outline && !style?.outlineStyle?.color && !style?.outlineStyle?.materialType
        }
      },
      {
        name: "outlineStyle",
        ...
        contant: "outlineWidth",
        show({ style, allStyle }) {
          return allStyle?.outline && !allStyle?.diffHeight && !style?.outlineWidth && style?.outlineStyle?.width
        }
      },
      {
        name: "outlineStyle",
        ...
        show({ style, allStyle }) {
          return (
            allStyle?.outline && !allStyle?.diffHeight && !style?.outlineColor && (style?.outlineStyle?.color || style?.outlineStyle?.materialType)
          )
        }
      },
