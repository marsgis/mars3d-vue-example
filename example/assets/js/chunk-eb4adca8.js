(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-eb4adca8"],{
...
var _hoisted_2 = /*#__PURE__*/Object(vue_runtime_esm_bundler["createTextVNode"])(" 显示限定范围 ");



/* harmony default export */ var cameraHistory_limitvue_type_script_setup_true_lang_ts = (/*#__PURE__*/Object(vue_runtime_esm_bundler["defineComponent"])({
  setup: function setup(__props) {
    ...
    Object(vue_runtime_esm_bundler["onMounted"])(function () {
      // 触发自定义事件，接收数据
      mapWork.eventTarget.on("changeCamera", function (event) {
      ...
      return Object(vue_runtime_esm_bundler["openBlock"])(), Object(vue_runtime_esm_bundler["createBlock"])(pannel["a" /* default */], {
        ...
        default: Object(vue_runtime_esm_bundler["withCtx"])(function () {
          return [Object(vue_runtime_esm_bundler["createElementVNode"])("div", _hoisted_1, [Object(vue_runtime_esm_bundler["createVNode"])(_component_a_checkbox, {
            checked: Object(vue_runtime_esm_bundler["unref"])(formState).chkUnderground,
            "onUpdate:checked": _cache[0] || (_cache[0] = function ($event) {
              return Object(vue_runtime_esm_bundler["unref"])(formState).chkUnderground = $event;
            }),
            ...
            _: 1
          }, 8, ["checked"])]), Object(vue_runtime_esm_bundler["createElementVNode"])("div", null, [Object(vue_runtime_esm_bundler["createElementVNode"])("p", null, "当前共有" + Object(vue_runtime_esm_bundler["toDisplayString"])(Object(vue_runtime_esm_bundler["unref"])(formState).allLength) + "条视角记录", 1)])];
        }),
        _: 1
      });
    };
...
// CONCATENATED MODULE: ./src/example/thing/camera/cameraHistory-limit/index.vue?vue&type=script&setup=true&lang=ts
 
// CONCATENATED MODULE: ./src/example/thing/camera/cameraHistory-limit/index.vue



const __exports__ = cameraHistory_limitvue_type_script_setup_true_lang_ts;

/* harmony default export */ var cameraHistory_limit = __webpack_exports__["default"] = (__exports__);
