(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-66d4a4c4"],{
...
/* harmony default export */ var billboardvue_type_script_setup_true_lang_ts = (/*#__PURE__*/Object(vue_runtime_esm_bundler["defineComponent"])({
  setup: function setup(__props) {
    var mapWork = window.mapWork;
    ...
    var btnStartBounce = function btnStartBounce() {
      mapWork.btnStartBounce();
    };

    var btnStartBounce2 = function btnStartBounce2() {
      mapWork.btnStartBounce2();
    };

    var btnStopBounce = function btnStopBounce() {
...
// CONCATENATED MODULE: ./src/example/graphic/entity/billboard/index.vue?vue&type=script&setup=true&lang=ts
 
// CONCATENATED MODULE: ./src/example/graphic/entity/billboard/index.vue



const __exports__ = billboardvue_type_script_setup_true_lang_ts;
