(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-3de16022"],{
...
var _hoisted_2 = /*#__PURE__*/Object(vue_runtime_esm_bundler["createTextVNode"])("危险圈");

var _hoisted_3 = /*#__PURE__*/Object(vue_runtime_esm_bundler["createTextVNode"])("警告圈");



/* harmony default export */ var point_lotvue_type_script_setup_true_lang_ts = (/*#__PURE__*/Object(vue_runtime_esm_bundler["defineComponent"])({
  setup: function setup(__props) {
    ...
    var formRedSphereChange = function formRedSphereChange() {
      mapWork.createEllipsoid(formState.enabledRedSphere, formState.enabledYellowSphere);
    };

    var formYellowSphereChange = function formYellowSphereChange() {
      mapWork.createEllipsoid(formState.enabledRedSphere, formState.enabledYellowSphere);
    };
      ...
      return Object(vue_runtime_esm_bundler["openBlock"])(), Object(vue_runtime_esm_bundler["createBlock"])(pannel["a" /* default */], {
        ...
        default: Object(vue_runtime_esm_bundler["withCtx"])(function () {
          return [Object(vue_runtime_esm_bundler["createElementVNode"])("div", _hoisted_1, [Object(vue_runtime_esm_bundler["createVNode"])(_component_a_checkbox, {
            checked: Object(vue_runtime_esm_bundler["unref"])(formState).enabledRedSphere,
            "onUpdate:checked": _cache[0] || (_cache[0] = function ($event) {
              return Object(vue_runtime_esm_bundler["unref"])(formState).enabledRedSphere = $event;
            }),
            onChange: formRedSphereChange
          }, {
            default: Object(vue_runtime_esm_bundler["withCtx"])(function () {
              return [_hoisted_2];
            }),
            _: 1
          }, 8, ["checked"])]), Object(vue_runtime_esm_bundler["createElementVNode"])("div", null, [Object(vue_runtime_esm_bundler["createVNode"])(_component_a_checkbox, {
            checked: Object(vue_runtime_esm_bundler["unref"])(formState).enabledYellowSphere,
            "onUpdate:checked": _cache[1] || (_cache[1] = function ($event) {
              return Object(vue_runtime_esm_bundler["unref"])(formState).enabledYellowSphere = $event;
            }),
            onChange: formYellowSphereChange
          }, {
            default: Object(vue_runtime_esm_bundler["withCtx"])(function () {
              return [_hoisted_3];
            }),
...
// CONCATENATED MODULE: ./src/example/graphic/primitive/point-lot/index.vue?vue&type=script&setup=true&lang=ts
 
// CONCATENATED MODULE: ./src/example/graphic/primitive/point-lot/index.vue



const __exports__ = point_lotvue_type_script_setup_true_lang_ts;

/* harmony default export */ var point_lot = __webpack_exports__["default"] = (__exports__);
